...
P.S. : We originally uploaded our assignments into moodle before the deadline. However we faced a simple bug about time and 
date on reservation activity and fixed our bug with Mr. Davenport permission after the deadline. 
-----------------------------------------------------------------------------------------------------------------------------------
...
Prerequisite: Make sure that you installed AndroidStudio and its Emulator (Pixel 2 is recommended).
	...
	4- On the login screen, you can sign up on your own (we recommend using your name when signing up for a little easter
	egg (: ) or you can use some of the accounts we created previously.
	
	Some accounts:
	
	- Customer account -
	Username: customerg3c@gmail.com
	Password: 123456
	
	-Restaurant Owner account - 
	Username: restaurantg3c@gmail.com
	Password: 123456
